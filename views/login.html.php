                    ...
                    <section id="homeContent" class="row m-0 flex-column align-items-center">
                        ...
                        <div id="fadeCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel"
                            ...
                            <div class="carousel-indicators">
                                ...
                                <button type="button" data-bs-target="#fadeCarousel" data-bs-slide-to="1"
                                    aria-label="Slide 2"></button>
                                <button type="button" data-bs-target="#fadeCarousel" data-bs-slide-to="2"
                                    aria-label="Slide 3"></button>
                                <button type="button" data-bs-target="#fadeCarousel" data-bs-slide-to="3"
        ...
        <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 py-5 border-top">
            ...
            <div class="col mb-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="https://secdesk.com/" class="nav-link p-0 text-body-secondary"
                            data-wpel-link="internal">Secdesk.com</a></li>
                    <li class="nav-item mb-2"><a href="https://secdesk.com/ask-secdesk/"
                            class="nav-link p-0 text-body-secondary" data-wpel-link="internal">Helpdesk</a></li>
                    <li class="nav-item mb-2"><a href="https://secdesk.com/blog/"
                            class="nav-link p-0 text-body-secondary" data-wpel-link="internal">Blog</a></li>
                    <li class="nav-item mb-2"><a href="https://secdesk.com/contact-us/"
                            class="nav-link p-0 text-body-secondary" data-wpel-link="internal">Contact</a></li>
                </ul>
            </div>
            ...
            <div class="col mb-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2">
                        <a href="https://secdesk.com/full-service-security/" class="nav-link p-0 text-body-secondary"
                            data-wpel-link="internal">SecDesk Subscription</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col mb-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="https://secdesk.com/penetration-test/"
                            class="nav-link p-0 text-body-secondary" data-wpel-link="internal">Penetration test</a></li>
                    <li class="nav-item mb-2"><a href="https://secdesk.com/vulnerability-scanning/"
                            class="nav-link p-0 text-body-secondary" data-wpel-link="internal">Vulnerability
                            scanning</a></li>
                    <li class="nav-item mb-2"><a href="https://secdesk.com/phishing-campaign/"
                            class="nav-link p-0 text-body-secondary" data-wpel-link="internal">Phishing campaign</a>
                    </li>
                    <li class="nav-item mb-2"><a href="https://secdesk.com/security-awareness-training-secdesk/"
                            class="nav-link p-0 text-body-secondary" data-wpel-link="internal">Security awareness</a>
                    </li>
                </ul>
            </div>
        </footer>
