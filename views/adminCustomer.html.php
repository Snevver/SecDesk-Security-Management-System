...
<head>
    ...
    <title>Admin - Customer Management | SecDesk</title>
...
<body class="vh-100 overflow-hidden">
    ...
    <header id="mainHeader" class="d-flex align-items-center justify-content-start justify-content-sm-start">
        <div class="d-flex flex-nowrap justify-content-center justify-content-xxl-between align-items-center text-center h-100 w-100">
            <!-- Logo -->
            ...
            <div class="d-none d-xxl-block" style="min-width: 101.4px;"></div>
        </div>
    </header>

    <!-- Sidebar Toggle Button for Mobile -->
    <button
    class="btn btn-light position-fixed top-0 start-0 m-2 d-flex justify-content-center align-items-center d-xxl-none z-1030"
    type="button"
    ...
    <div class="content-wrapper d-flex">
        <div id="sidebarCollapse" class="collapse d-xxl-flex flex-column flex-shrink-0 bg-light">
            <!-- Logo only -->
        ...
        <main class="d-flex justify-content-center w-100 align-items-end">
            <section id="userDashboard" class="w-100 d-flex flex-column">
                    ...
                    <section id="testList" class="container-fluid p-0 ms-3 me-3 rounded">
						...
						<header id="testListHeader" class="mb-3 mt-3 ms-xxl-0 me-xxl-0 ms-3 me-3 rounded">
							<div class="h-100 fs-2 d-flex flex-nowrap justify-content-between align-items-center">
								<h2 class="mb-0 flex-grow-1 text-center" >Customer Details</h2>
							</div>
						</header>
						...
						<div id="testListAccordion" class="accordion row ms-3 me-3">
                            <div class="container-fluid">
                                <div class="container p-0">
                                    <!-- Customer Info Card -->
                                    <div class="row mb-4 user-card rounded p-3 ms-0 me-0 w-100" style="height: 80%; overflow-y: auto;">
                                        <div class="col-12">
                                            <div class="stats-card">
                                                <div class="row">
                                                    <div class="col-md-8 col-sm-7 col-12">
                                                        <h3 id="customer-name">Loading Customer...</h3>
                                                        <p class="text-muted m-0" id="customer-email">Loading...</p>
                                                        <p class="text-muted mb-3 mb-sm-0">
                                                    ...
                                                    <div class="col-md-4 col-sm-5 col-12">
                                                        <div class="row text-center">
                                                            ...
                                                            <div class="col-4">
                                                                ...
                                                                <small clas="text-muted">Vulnerabilities</small>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <!-- Navigation Tabs -->
                                    <ul class="nav nav-tabs rounded-top" id="customerTabs" role="tablist">
                                    ...
                                    <div class="flex-grow-1 overflow-hidden mb-3">
                                        <!-- Tab Content -->
                                        <div class="tab-content rounded-bottom p-4 overflow-auto" id="customerTabContent">
                                            <!-- Tests Tab -->
                                            <div class="tab-pane fade show active h-100" id="tests" role="tabpanel">
                                                <div class="stats-card">
                                                    <div class="table-responsive rounded">
                                                        <table class="table table-hover rounded m-0">
                                                            <thead class="rounded">
                                                                <tr>
                                                                    <th>ID</th>
                                                                    <th>Name</th>
                                                                ...
                                                                <tr>
                                                                    <td colspan="7" class="text-center">
                                                                        <div class="text-center p-4">
                                                                            ...
                                                                            <p class="mt-2 text-muted">Loading tests...</p>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                            ...
                                            <!-- Targets Tab -->
                                            <div class="tab-pane fade h-100" id="targets" role="tabpanel">
                                                <div class="stats-card">
                                                    <div class="table-responsive rounded">
                                                        <table class="table table-hover rounded m-0">
                                                            <thead class="rounded">
                                                                ...
                                                                <tr>
                                                                    <td colspan="5" class="text-center">
                                                                        <div class="text-center p-4">
                                                                            ...
                                                                            <p class="mt-2 text-muted">Loading targets...</p>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                            ...
                                            <!-- Vulnerabilities Tab -->
                                            <div class="tab-pane fade h-100" id="vulnerabilities" role="tabpanel">
                                                <div class="stats-card">
